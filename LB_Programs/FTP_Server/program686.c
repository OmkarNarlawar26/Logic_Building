...
int main(int argc, char *argv[])
{
    ...
    if((argc < 2) || (argc > 2))
    {
        ...
        printf("Please provide tha port number\n");
        return -1;
    }
    ...
    while(1)
    {
        ...
        //////////////////////////////////////////////////////////////////////
        // Step 5 : Create new process of handle client request
        //////////////////////////////////////////////////////////////////////
        ...
        if(pid == 0)
        {
            printf("New Porcess is created for client requent\n");
            ...
            printf("File transfer done and client disconnected");
